...
const birthDateSorted = inventors.sort((firstPerson, secondPerson) => firstPerson.year > secondPerson ? 1 : -1);


// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
const sumOfYears = inventors.reduce((acc, value) => {
